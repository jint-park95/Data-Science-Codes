...
- Goal of this portfolio is to surface and report on unoccupied bike movements to be able to validate any suspicious movements or transportating efforts un-associated with active users 
